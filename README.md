...
* [Common `xmlns`](https://github.com/hovermind/XF/blob/master/common-xmlns.md)
* [Markup Extension](https://github.com/hovermind/XF/blob/master/markup-extension.md)
* [Common Markup Extensions](https://github.com/hovermind/XF/blob/master/common-markup-extension.md)
* [`x:Static` vs `StaticResource`](https://github.com/hovermind/XF/blob/master/xstatic-vs-static-resource.md)
* Misc
